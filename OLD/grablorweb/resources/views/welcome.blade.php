...
<div class="d-flex justify-content-center">
    ...
    @else
        {{-- <a class="nav-link" href="{{ route('login') }}"><button type="button" class="btn btn-primary btn-lg">Login</button>
        </a>
        @if (Route::has('register'))
        
            <a class="nav-link" href="{{ route('register') }}"><button type="button" class="btn btn-primary btn-lg">Register</button>
            </a> --}}
