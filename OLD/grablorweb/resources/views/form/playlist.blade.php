...
<div class="modal fade" id="exampleModal3{{$playlists->version}}{{$playlists->playlistId}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="text-center">
   <a href="http://70.35.205.86/index.php/api/appdata/{{$createapps->appname}}/{{$createapps->packagename}}/{{$createapps->icon}}/{{$profile->developername}}/{{$createapps->version_no}}"><button type="text" class="btn btn-success">Finish Playlist & Create Application</button></a>
  </div>
  @else
