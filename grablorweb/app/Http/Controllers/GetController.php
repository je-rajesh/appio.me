...
class GetController extends Controller
{
    public function config($id,$app){
        ...
        echo "<pre>"; 
         return $createapp->toJson(JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
    ...
    public function playlist($id,$app){
        ...
        echo "<pre>"; 
        return $playlist->toJson(JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
    ...
    public function video($id,$app,$pid){
        ...
        echo "<pre>"; 
        return $video->toJson(JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
