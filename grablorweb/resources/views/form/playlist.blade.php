  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="/playlist2" enctype="multipart/form-data">
            {{ csrf_field() }}
...
<div class="modal fade" id="exampleModal3{{$playlists->version}}{{$playlists->playlistId}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="text-center">
    <a href="/index"><button type="text" class="btn btn-success">Finish Playlist & Create Application</button></a>

   {{-- <a href="http://70.35.205.86/development/index.php/api/appdata/{{$createapps->appname}}/{{$createapps->packagename}}/{{$createapps->icon}}/{{$createapps->startappid}}"><button type="text" class="btn btn-success">Finish Playlist & Create Application</button></a> --}}
