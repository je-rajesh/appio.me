...
@section('content')
 ...
 <div class="container">
<form name="myForm" id="myForm" data-toggle="validator" role="form" method="post" action="/multiform/{{$createapp->id}}" enctype="multipart/form-data"  accept-charset="utf-8">
     ...
     <div id="step-1" class="tab-pane" role="tabpanel">
       ...
       <div class="ml-2 col-sm-6">
        ...
        <div class="input-group my-3">
          <input type="text" class="form-control" disabled placeholder="Upload File" id="file" value="{{$createapp->icon}}
          ">
          <div>
...
<img  height="100%" width="100%" src="{{$createapp->icon}}" id="preview" class="img-thumbnail">
</div>
     </div>
     ...
     <div id="step-2" class="tab-pane" role="tabpanel">
      ...
      <input type="text" name="apikey" class="form-control" id="apikey" value="{{$createapp->apikey}}" aria-describedby="emailHelp" placeholder="API Key" value="">
     ...
     <div class="form-group">
      <div class="form-group" style="margin: 1rem">
        ...
        <input type="text" value="{{$createapp->appname}}" name="appname" class="form-control getinfo" id="appname" aria-describedby="emailHelp" placeholder="App Name">
        <meta name="csrf-token" content="{{ csrf_token() }}" />
        <label for="exampleInputEmail1">Package Name</label><span style="color: red" id="packagenameerror"></span>
        <input type="text" value="{{$createapp->packagename}}" name="packagename" class="form-control" id="packagename" aria-describedby="emailHelp" placeholder="Package Name">
        <label for="exampleInputEmail1">Support Email</label><span style="color: red" id="supportemailerror"></span>
        <input type="text" value="{{$createapp->supportemail}}" name="supportemail" class="form-control" id="supportemail" aria-describedby="emailHelp" placeholder="Support Email">
        <label for="exampleInputEmail1">Redirect URL</label><span style="color: red" id="redirecturlerror"></span>
        <input type="text" value="{{$createapp->redirecturl}}" name="redirecturl" class="form-control" id="redirecturl" aria-describedby="emailHelp" placeholder="Redirect URL">
        <label for="exampleInputEmail1">Privacy Policy URL</label><span style="color: red" id="privacypolicyerror"></span>
        <input type="text" value="{{$createapp->privacypolicy}}" name="privacypolicy" class="form-control" id="privacypolicy" aria-describedby="emailHelp" placeholder="Privacy Policy URL">
      </div>
    </div>
     ...
     <div style="height: 30rem" id="step-3" class="tab-pane" role="tabpanel">
       ...
       <div class="container">
        <div class="form-group">
          ...
          <input type="text" value="{{$createapp->fbappid}}" name="fbappid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Banner Id</label>
          <input type="text" value="{{$createapp->fbbannerid}}" name="fbbannerid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div><div class="form-group">
          <label for="exampleInputEmail1">Intertential Id</label>
          <input type="text" value="{{$createapp->fbinterid}}" name="fbinterid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
      </div>
      </div>
      <div class="col-6">
       <label>AdMob:</label>
       @if($createapp->admob==1)
       ...
       <div class="container">
        <div class="form-group">
          <label for="exampleInputEmail1">App Id</label>
          <input type="text" value="{{$createapp->adappid}}" name="adappid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Banner Id</label>
          <input type="text" value="{{$createapp->adbannerid}}" name="adbannerid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div><div class="form-group">
          <label for="exampleInputEmail1">Intertential Id</label>
          <input type="text" value="{{$createapp->adinterid}}" name="adinterid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
      </div>
      </div>
      </div>
