...
<img  height="100%" width="100%" src="" id="preview" class="img-thumbnail">
     ...
     <div class="form-group">
      <div class="form-group" style="margin: 1rem">
        ...
        <input type="text" value="<?php echo e($devname); ?>" name="packagename" class="form-control" id="packagename" aria-describedby="emailHelp" placeholder="Package Name">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rex/rajesh/code/software-management-system/grablorweb/resources/views/form/multiform.blade.php ENDPATH**/ ?>