...
<?php $__env->startSection('content'); ?>
 ...
 <div class="container">
<form name="myForm" id="myForm" data-toggle="validator" role="form" method="post" action="/multiform/<?php echo e($createapp->id); ?>" enctype="multipart/form-data"  accept-charset="utf-8">
     ...
     <div id="step-1" class="tab-pane" role="tabpanel">
       ...
       <div class="ml-2 col-sm-6">
        ...
        <div class="input-group my-3">
          <input type="text" class="form-control" disabled placeholder="Upload File" id="file" value="<?php echo e($createapp->icon); ?>
...
<img  height="100%" width="100%" src="<?php echo e($createapp->icon); ?>" id="preview" class="img-thumbnail">
</div>
     </div>
     ...
     <div id="step-2" class="tab-pane" role="tabpanel">
      ...
      <input type="text" name="apikey" class="form-control" id="apikey" value="<?php echo e($createapp->apikey); ?>" aria-describedby="emailHelp" placeholder="API Key" value="">
     ...
     <div class="form-group">
      <div class="form-group" style="margin: 1rem">
        ...
        <input type="text" value="<?php echo e($createapp->appname); ?>" name="appname" class="form-control getinfo" id="appname" aria-describedby="emailHelp" placeholder="App Name">
        <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>" />
        <label for="exampleInputEmail1">Package Name</label><span style="color: red" id="packagenameerror"></span>
        <input type="text" value="<?php echo e($createapp->packagename); ?>" name="packagename" class="form-control" id="packagename" aria-describedby="emailHelp" placeholder="Package Name">
        <label for="exampleInputEmail1">Support Email</label><span style="color: red" id="supportemailerror"></span>
        <input type="text" value="<?php echo e($createapp->supportemail); ?>" name="supportemail" class="form-control" id="supportemail" aria-describedby="emailHelp" placeholder="Support Email">
        <label for="exampleInputEmail1">Redirect URL</label><span style="color: red" id="redirecturlerror"></span>
        <input type="text" value="<?php echo e($createapp->redirecturl); ?>" name="redirecturl" class="form-control" id="redirecturl" aria-describedby="emailHelp" placeholder="Redirect URL">
        <label for="exampleInputEmail1">Privacy Policy URL</label><span style="color: red" id="privacypolicyerror"></span>
        <input type="text" value="<?php echo e($createapp->privacypolicy); ?>" name="privacypolicy" class="form-control" id="privacypolicy" aria-describedby="emailHelp" placeholder="Privacy Policy URL">
      </div>
    </div>
     ...
     <div style="height: 30rem" id="step-3" class="tab-pane" role="tabpanel">
       ...
       <?php if($createapp->facebook==1): ?>
       <input type="checkbox" class="advertise" name="facebook" value="1" checked/>
       <?php else: ?>
       ...
       <div class="container">
        <div class="form-group">
          ...
          <input type="text" value="<?php echo e($createapp->fbappid); ?>" name="fbappid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Banner Id</label>
          <input type="text" value="<?php echo e($createapp->fbbannerid); ?>" name="fbbannerid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div><div class="form-group">
          <label for="exampleInputEmail1">Intertential Id</label>
          <input type="text" value="<?php echo e($createapp->fbinterid); ?>" name="fbinterid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
      </div>
      </div>
      <div class="col-6">
       <label>AdMob:</label>
       <?php if($createapp->admob==1): ?>
       <input type="checkbox" name="admob" class="advertise" value="1" checked />
       <?php else: ?>
       ...
       <div class="container">
        <div class="form-group">
          <label for="exampleInputEmail1">App Id</label>
          <input type="text" value="<?php echo e($createapp->adappid); ?>" name="adappid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Banner Id</label>
          <input type="text" value="<?php echo e($createapp->adbannerid); ?>" name="adbannerid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div><div class="form-group">
          <label for="exampleInputEmail1">Intertential Id</label>
          <input type="text" value="<?php echo e($createapp->adinterid); ?>" name="adinterid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
      </div>
      </div>
      </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/grabliyw/public_html/appio.studio/grablorweb/resources/views/form/edit.blade.php ENDPATH**/ ?>