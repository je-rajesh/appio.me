<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><title>App Landing</title><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css" integrity="sha512-+4zCK9k+qNFUR5X+cKL9EIR+ZOhtIloNl9GIKS57V1MyNsYpYcUrUeQc9vNfzsWfV28IaLL3i96P9sdNyeRssA==" crossorigin="anonymous" /><link rel="shortcut icon" href="favicons/img-fv.png" type="image/x-icon"><link rel="icon" href="favicons/img-fv.png" type="image/x-icon"><link rel="stylesheet" href="css/css-bootstrap.min.css"><link rel="stylesheet" href="css/css-animate.css"><link rel="stylesheet" href="css/css-newfont.css"><link rel="stylesheet" href="css/css-owl.carousel.css"><link rel="stylesheet" href="css/css-fontawesome-all.css"><link rel="stylesheet" href="css/css-swiper.css"><link rel="stylesheet" href="css/css-jquery.bxslider.min.css"><link rel="stylesheet" href="css/css-jquery.mCustomScrollbar.min.css"><link rel="stylesheet" href="css/css-odometer-theme-default.css"><link rel="stylesheet" href="css/css-flaticon.css"><link rel="stylesheet" href="css/css-style.css"></head><body class="app-eight-home" data-spy="scroll" data-target=".navigation-eight" data-offset="50">
    <!-- preloader - start -->
    ...
    <!-- Start of header section
        ============================================= -->
        <header id="header-eight" class="main-header-eight"><div class="appheader-content">
                <div class="site-logo float-left">
                    <a href="#"><img src="/storage/icon_image/images/logo-logo1.png" alt=""></a>
                </div>
                <nav class="navigation-eight ul-li"><ul><li><a class="nav-link" href="#eight-banner">Home</a></li>
                    ...
                    </ul></nav><div class="h-eight-social ul-li float-right clearfix">
                ...
                <div class="appi-ei-mobile_menu_wrap">
                    ...
                    <div class="appi-ei-mobile_menu_content">
                        ...
                        <div class="m-brand-logo text-center">
                            <img src="/storage/icon_image/images/logo-f-logo.png" alt=""></div>
                        <nav class="appi-ei-mobile-main-navigation  clearfix ul-li"><ul id="main-nav" class="navbar-nav text-capitalize clearfix"><li><a class="nav-link" href="#eight-banner">Home</a></li>
                                <li><a class="nav-link" href="#feature-eight">Features</a></li>
                                <li><a class="nav-link" href="#eight-service">Showcase</a></li>
                                <li><a class="nav-link" href="#ei-team">Team</a></li>
                                <li><a class="nav-link" href="#ei-faq">FAQ</a></li>
        ...
        ============================================= -->
        <section id="eight-banner" class="eight-banner-section position-relative"><div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="eight-banner-content">
                            <div class="banner-content-box appeight-headline pera-content">
                                ...
                                <div class="ei-banner-review pera-content ul-li">
                                    <ul><li><i class="fas fa-star"></i></li>
                                        <li><i class="fas fa-star"></i></li>
                                        <li><i class="fas fa-star"></i></li>
                                        <li><i class="fas fa-star"></i></li>
                                        <li><i class="fas fa-star"></i></li>
                                    </ul><p>(based on <span>1,256 task</span> reviews)</p>
                                </div>
                            </div>
                            <div class="ei-banner-mbl-mockup wow fadeInRight" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <img src="/storage/icon_image/images/mockup-bm1.png" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        ============================================= --><section id="feature-eight" class="feature-eight-section position-relative"><div class="container">
                ...
                <div class="ei-feature-shape"><img src="/storage/icon_image/images/shape-f-shape1.png" alt=""></div>
            </section><!-- End of Featured section
        ============================================= --><!-- Start of service  section
        ============================================= --><section id="eight-service" class="eight-service-section position-relative"><div class="container">
                <div class="eight-service-slide   clearfix wow fadeFromLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                    <div class="ei-service-slide-btn ul-li-block clearfix">
                        <div class="banner-pager clearfix" id="banner-pager">
                            <a class="pager" data-slide-index="0" href="Saasio.html">
                            ...
                            <a class="pager" data-slide-index="1" href="Saasio.html">
                                <div class="ei-service-icon-text text-right appeight-headline pera-content">
                                    <div class="ei-service-icon float-right text-center">
                            ...
                            <a class="pager" data-slide-index="2" href="Saasio.html">
                                <div class="ei-service-icon-text text-right appeight-headline pera-content">
                                    <div class="ei-service-icon float-right text-center">
                        ...
                        <div class="slide-inner">
                            <div class="ei-service-slide">
                                <div class="slide-item">
                                    <div class="image">
                                        <img src="/storage/icon_image/images/screenshoot-slider-01.jpg" alt=""></div>
                                </div>
                                <div class="slide-item">
                                    <div class="image">
                                        <img src="/storage/icon_image/images/screenshoot-slider-01.jpg" alt=""></div>
            ...
            <div class="s-shape-bg1" data-parallax='{"x" : -70}'><img src="/storage/icon_image/images/shape-s-shape3.png" alt=""></div>
            <div class="s-shape-bg2 text-center"><img src="/storage/icon_image/images/shape-s-shape4.png" alt=""></div>
        </section><!-- End of service  section
        ============================================= --><!-- Start of Fun fact   section
        ============================================= --><section id="fun-fact" class="eg-fun-fact-section position-relative"><div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="eg-funfact-content clearfix position-relative">
                            <div class="eg-fun-fact-mockup wow fadeFromLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="main-mockup">
                                    <img src="/storage/icon_image/images/mockup-fmu1.png" alt=""></div>
                                <div class="fn-shape fn-shape-item1" data-parallax='{"y" : 50}'><img src="/storage/icon_image/images/mockup-fmu2.png" alt=""></div>
                                <div class="fn-shape fn-shape-item2" data-parallax='{"y" : 60}'><img src="/storage/icon_image/images/mockup-fmu3.png" alt=""></div>
                                <div class="fn-shape fn-shape-item3" data-parallax='{"x" : -50}'><img src="/storage/icon_image/images/shape-fc1.png" alt=""></div>
                                <div class="fn-shape fn-shape-item4" data-parallax='{"x" : -40}'><img src="/storage/icon_image/images/shape-fc2.png" alt=""></div>
                            </div>
                    ...
                    <div class="fn-bg-shape position-absolute"><img src="/storage/icon_image/images/shape-fns1.png" alt=""></div>
                </section><!-- End of Fun fact  section
        ============================================= --><!-- Start of How work  section
        ============================================= --><section id="eg-how-work" class="eg-how-work-section position-relative"><div class="how-work-bg-shape position-absolute"><img src="/storage/icon_image/images/shape-hws.png" alt=""></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                    ...
                    <div class="col-lg-5">
                        <div class="how-work-mockup position-relative wow fadeFromUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="hw-mockup-img">
                                <img src="/storage/icon_image/images/mockup-hw.gif" alt=""></div>
                            <div class="hw-shape1 position-absolute" data-parallax='{"x" : 40}'><img src="/storage/icon_image/images/shape-fc1.png" alt=""></div>
                            <div class="hw-shape2 position-absolute" data-parallax='{"x" : -30}'><img src="/storage/icon_image/images/shape-fc2.png" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
        </section><!-- End  of How work  section
        ============================================= --><!-- Start of App Download  section
        ============================================= --><section id="ei-appdownload" class="ei-appdownload-section position-relative" data-background="assets/img/app-landing/background/appbg1.png"><div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="ei-app-mockup-img  wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <img src="/storage/icon_image/images/mockup-amu1.png" alt=""></div>
                        </div>
                        <div class="col-lg-6">
                            <div class="ei-app-down-text wow fadeFromLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
                                ...
                                <div class="app-down-btn">
                                    <a href="#"><img src="/storage/icon_image/images/shape-btn1.png" alt=""></a>
                                    <a href="#"><img src="/storage/icon_image/images/shape-btn2.png" alt=""></a>
                                </div>
            ...
            <div class="ei-appdownloaad-shape app-shape1" data-parallax='{"y" : -100}'><img src="/storage/icon_image/images/background-apps1.png" alt=""></div>
            <div class="ei-appdownloaad-shape app-shape2" data-parallax='{"x" : -120}'><img src="/storage/icon_image/images/background-apps2.png" alt=""></div>
            <div class="ei-appdownloaad-shape app-shape3" data-parallax='{"y" : -100}'><img src="/storage/icon_image/images/background-apps3.png" alt=""></div>
        </section><!-- End of App Download section
        ============================================= --><!-- Start of team section
        ============================================= --><section id="ei-team" class="ei-team-section"><div class="container">
                <div class="eight-section-title appeight-headline pera-content text-center">
                ...
                <div id="ei-team-slide" class="ei-team-content owl-carousel">
                    <div class="ei-team-pic-text wow fadeFromLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="ei-team-img position-relative">
                            <div class="team-mem-img-ei text-center position-relative">
                                <img src="/storage/icon_image/images/team-tm1.png" alt=""><span class="mshape-bg shape-bg1"><img src="images/team-msbg1.png" alt=""></span>
                                <span class="mshape-bg shape-bg2"><img src="/storage/icon_image/images/team-msbg2.png" alt=""></span>
                            </div>
                    ...
                    <div class="ei-team-pic-text wow fadeFromLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="ei-team-img position-relative">
                            <div class="team-mem-img-ei text-center position-relative">
                                <img src="/storage/icon_image/images/team-tm2.png" alt=""><span class="mshape-bg shape-bg1"><img src="images/team-msbg1.png" alt=""></span>
                                <span class="mshape-bg shape-bg2"><img src="/storage/icon_image/images/team-msbg2.png" alt=""></span>
                            </div>
                            <div class="ei-team-social">
                                <a href="#"><i class="fab fa-facebook-f "></i></a>
                    ...
                    <div class="ei-team-pic-text wow fadeFromLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="ei-team-img position-relative">
                            <div class="team-mem-img-ei text-center position-relative">
                                <img src="/storage/icon_image/images/team-tm3.png" alt=""><span class="mshape-bg shape-bg1"><img src="images/team-msbg1.png" alt=""></span>
                                <span class="mshape-bg shape-bg2"><img src="/storage/icon_image/images/team-msbg2.png" alt=""></span>
                            </div>
                            <div class="ei-team-social">
                                <a href="#"><i class="fab fa-facebook-f "></i></a>
                    ...
                    <div class="ei-team-pic-text">
                        <div class="ei-team-img position-relative">
                            <div class="team-mem-img-ei text-center position-relative">
                                <img src="images/team-tm1.png" alt=""><span class="mshape-bg shape-bg1"><img src="/storage/icon_image/images/team-msbg1.png" alt=""></span>
                                <span class="mshape-bg shape-bg2"><img src="/storage/icon_image/images/team-msbg2.png" alt=""></span>
                            </div>
                            <div class="ei-team-social">
                                <a href="#"><i class="fab fa-facebook-f "></i></a>
        ...
        ============================================= --><section id="ei-faq" class="ei-faq-section position-relative"><div class="container">
                <div class="row">
                    <div class="col-md-12">
                ...
                <span class="ei-faq-shape fq-shape-style1" data-parallax='{"x" : 50}'><img src="/storage/icon_image/images/shape-fq-shape1.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style2"><img src="/storage/icon_image/images/shape-fq-shape2.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style3"><img src="/storage/icon_image/images/shape-fq-shape3.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style4" data-parallax='{"y" : 60}'><img src="/storage/icon_image/images/shape-fq-shape4.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style5"><img src="/storage/icon_image/images/shape-fq-shape5.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style6"><img src="/storage/icon_image/images/shape-fq-shape6.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style8"><img src="/storage/icon_image/images/shape-fq-shape8.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style7"><img src="/storage/icon_image/images/shape-fq-shape7.png" alt=""><img src="/storage/icon_image/images/shape-fq-shape7.png" alt=""><img src="/storage/icon_image/images/shape-fq-shape7.png" alt=""></span>
                </section><!-- End of Faq section
        ============================================= --><!-- Start of screen-shoot section
        ============================================= --><section id="ei-screenshots" class="ei-screenshots-section position-relative"><div class="container">
                <div class="eight-section-title appeight-headline pera-content text-center">
                ...
                <div class="screenshoot-vector screenshoot-shape1 position-absolute"> <img src="/storage/icon_image/images/shape-ss-shape1.png" alt=""></div>
                <div class="screenshoot-vector screenshoot-shape2 position-absolute"> <img src="/storage/icon_image/images/shape-ss-shape2.png" alt=""></div>
            </section><!-- End of screen-shoot section
        ============================================= --><!-- Start of Testimonial section
    ============================================= --><section id="ei-testimonial" class="ei-testimonial-section position-relative" data-background="assets/img/app-landing/background/tbg.jpg"><div class="container">
            <div class="eight-section-title appeight-headline pera-content text-center">
                <span class="eg-title-tag">
                    Testimonials<i class="square-shape"> <i></i><i></i><i></i><i></i> </i>
                </span>
                <h2>
                    Client&rsquo;s review for
                ...
                <div id="testimonial-scroller" class="testimonial-scroller-area owl-carousel">
                    <div class="ei-testimonial-img-text position-relative">
                        ...
                        <div class="ei-testimonial-img float-left text-center">
                            <img src="/storage/icon_image/images/testimonial-tst1.jpg" alt=""></div>
                    ...
                    <div class="ei-testimonial-img-text position-relative">
                        ...
                        <div class="ei-testimonial-img float-left text-center">
                            <img src="/storage/icon_image/images/testimonial-tst2.jpg" alt=""></div>
                        <div class="ei-testimonial-text">
                            <div class="ei-testimonial-name appeight-headline pera-content">
                                <h3>Liana Zhu</h3>
                                <span>Senior Director</span>
        ...
        <div class="testimonial-floatingimg testimonial-float-img1 ul-li-block">
            <ul><li><img src="/storage/icon_image/images/testimonial-tf1.jpg" alt=""></li>
                <li><img src="/storage/icon_image/images/testimonial-tf3.jpg" alt=""></li>
                <li><img src="/storage/icon_image/images/testimonial-tst1.jpg" alt=""></li>
                <li><img src="/storage/icon_image/images/testimonial-tst2.jpg" alt=""></li>
            </ul></div>
    ...
    ============================================= --><!-- Start of Partner  section
        ============================================= --><section id="ei-partner" class="ei-partner-section"><div class="container">
                <div class="ei-partner-content">
                    <div id="ei-partner-slide" class="partner-slide-area owl-carousel">
                        <div class="partner-img">
                            <img src="/storage/icon_image/images/partner-p1.png" alt=""></div>
                        <div class="partner-img">
                            <img src="/storage/icon_image/images/partner-p2.png" alt=""></div>
                        <div class="partner-img">
                            <img src="/storage/icon_image/images/partner-p3.png" alt=""></div>
                        <div class="partner-img">
                            <img src="/storage/icon_image/images/partner-p4.png" alt=""></div>
        ...
        </section><!-- End  of Partner  section
        ============================================= --><!-- Start of Newslatter  section
        ============================================= --><section id="ei-newslatter" class="ei-newslatter-section position-relative"><div class="ei-newslatter-box position-relative">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ei-newslatter-contnet appeight-headline pera-content">
                                ...
                                <div class="ei-newslatter-form position-relative">
                                    <form action="#">
                                        <input class="email" name="email" type="email" placeholder="Enter your email address"><div class="nws-button position-absolute text-capitalize">
                                            <button class="hover-btn" type="submit" value="Submit"> Subscribe Now</button>
                                        </div>
                                        <p>* Your mail address will be fully secure . We don&rsquo;t share!</p>
                                    </form>
                                </div>
                            </div>
                        </div>
                ...
                <div class="ei-news-vector1 position-absolute"><img src="/storage/icon_image/images/shape-n-shape1.png" alt=""></div>
                <div class="ei-news-vector2 position-absolute"><img src="/storage/icon_image/images/shape-n-shape2.png" alt=""></div>
                <div class="ei-news-vector3 position-absolute" data-parallax='{"x" : 50}'><img src="/storage/icon_image/images/shape-n-shape3.png" alt=""></div>
            </div>
            <div class="ei-newslatter-mockup">
                <img src="images/mockup-n-mockup.png" alt=""></div>
        </section><!-- End of Newslatter  section
        ============================================= --><!-- Start of Footer  section
        ============================================= --><section id="ei-footer" class="ei-footer-section position-relative"><div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="ei-footer-widget pera-content appeight-headline">
                            ...
                            <div class="ei-payment-mathod">
                                <img src="/storage/icon_image/images/logo-paypal.png" alt=""></div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="ei-footer-widget appeight-headline  ul-li-block">
                            ...
                            <div class="download-btn">
                                <a href="#"><img src="/storage/icon_image/images/logo-app1.png" alt=""></a>
                                <a href="#"><img src="/storage/icon_image/images/logo-gp1.png" alt=""></a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="ei-copyright-text">
                                    <p>&copy; 2020 <a href="#">Themexriver</a></p>
                                </div>
                            </div>
                            <div class="col-md-8">
            ...
            <div class="ei-footer-shape1 position-absolute" data-parallax='{"x" : 60}'><img src="/storage/icon_image/images/shape-fo-shape1.png" alt=""></div>
            <div class="ei-footer-shape2 position-absolute" data-parallax='{"y" : 60}'><img src="/storage/icon_image/images/shape-fo-shape2.png" alt=""></div>
            <div class="ei-footer-shape3 position-absolute"><img src="/storage/icon_image/images/shape-eimap.png" alt=""></div>
        </section><!-- End of Footer  section
        ============================================= --><!-- JS library --><script src="js/js-jquery.js"></script><script src="js/js-popper.min.js"></script><script src="js/js-bootstrap.min.js"></script><script src="js/js-appear.js"></script><script src="js/js-owl.js"></script><script src="js/js-wow.min.js"></script><script src="js/js-aos.js"></script><script src="js/js-slick.js"></script><script src="js/js-pagenav.js"></script><script src="js/js-odometer.js"></script><script src="js/js-bxslider.js"></script><script src="js/js-jquery.barfiller.js"></script><script src="js/js-jquery.mCustomScrollbar.concat.min.js"></script><script src="js/js-parallax-scroll.js"></script><script src="js/js-swiper.min.js"></script><script src="js/js-typer-new.js"></script><script src="js/js-script.js"></script></body></html>
<?php /**PATH /home/rex/rajesh/code/software-management-system/grablorweb/resources/views/form/home.blade.php ENDPATH**/ ?>